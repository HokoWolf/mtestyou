...
require(dirname(__FILE__).'/../../php/login/student_signup_script.php');
?>
...
<head>
	...
	<link rel="stylesheet" href="/media/css/login-bg2.css">
  ...
  <div class="login">
    ...
    <form method="POST">
      ...
      <div class="form-group">
        ...
        <input type="email" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Введите Ваш Email" value="<?php echo @$data['email']; ?>">
      </div>
